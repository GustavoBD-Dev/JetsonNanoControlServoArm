...
def runScene(script, positions):
    restartPositionArm()
    print("Execute escene to : ", script)
    # get steps of scene
    scene = getStepsScene(positions)
...
print(azulBajo," - ", azulAlto)
print(verdeBajo, " - ", verdeAlto)
print(rojoBajo, " - ", rojoAlto)

# object to contorl servos
kit = ServoKit(channels=16)
cap = cv2.VideoCapture(0)
c = 1
timeRate = 5 # interval of time in seconds
...
#     img = cv2.imread(cv2.samples.findFile("foto.png"))
...
#     try:
#         B = dibujar(maskAzul,(255,0,0))
#         G = dibujar(maskVerde,(0,255,0))
#         R = dibujar(maskRojo,(0,0,255))
#         print(B, " - ", G, " - ", R)
#     except:
#         print("No color!!!!!!!")
